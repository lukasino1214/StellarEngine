...
// *************** Descriptor Set Layout *********************
    ...
    DescriptorSetLayout::DescriptorSetLayout(Device &Device, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings) : m_Device{Device}, bindings{bindings} {

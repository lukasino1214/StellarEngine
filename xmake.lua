...
set_optimize("fastest")
packages = {"glfw", "glm", "spdlog", "yaml-cpp", "fmt", "tinyobjloader", "vulkan", "entt", "stb", "shaderc", "fx-gltf", "tinygltf"}
...
target("Vendor")
    ...
    add_headerfiles("Vendor/*/*.h", "Vendor/*/*.hpp")
    add_packages("glfw", "glm", "shaderc", "stb")
target_end()

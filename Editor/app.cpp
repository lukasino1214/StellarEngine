...
namespace Engine {
    FirstApp::FirstApp() {
        ...
        m_OffScreenRenderingSystem = std::make_unique<OffScreen>();
        ...
        m_Imgui = std::make_unique<Imgui>(*m_Window, m_Renderer->getSwapChainRenderPass(), m_Renderer->getImageCount());
    ...
    void FirstApp::run() {
        ...
        while (!m_Window->shouldClose()) {
            ...
            if(resize) {
                m_OffScreenRenderingSystem->SetViewportSize({m_ViewportSize.x , m_ViewportSize.y});

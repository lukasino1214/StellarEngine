...
namespace Engine {
    ...
    ContentBrowserPanel::ContentBrowserPanel() : m_CurrentDirectory(g_AssetPath) {
        m_FileIcon = std::make_unique<Texture>("assets/file.png");
        m_DirectoryIcon = std::make_unique<Texture>("assets/directory.png");
    }
    ...
    void ContentBrowserPanel::OnImGuiRender() {
        static auto file_set = ImGui_ImplVulkan_AddTexture(m_FileIcon->GetSampler(), m_FileIcon->GetImageView(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
        static auto directory_set = ImGui_ImplVulkan_AddTexture(m_DirectoryIcon->GetSampler(), m_DirectoryIcon->GetImageView(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
